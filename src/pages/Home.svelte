    ...
    <div class="contents">
        ...
        {#each $passwords as password}
            <div class="card">
                <div class="userInfo">
                    <h1 class="title">
                        {password.name || $_("start.placeholder.name")}
                    </h1>
                    <p class="username">
                        {password.username || $_("start.placeholder.username")}
                    </p>
                </div>
