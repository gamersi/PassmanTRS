    ...
    <form on:submit|preventDefault={editPassword}>
        <div class="row">
            ...
            <input
                ...
                class="form-control"
                id="name"
                placeholder={$_("editpw.name")}
                value={password.name}
            />
        </div>
        <div class="row">
            <label for="username" class="form-label"
                >{$_("editpw.username")}</label
            >
            <input
                type="text"
                class="form-control"
                id="username"
                placeholder={$_("editpw.username")}
                value={password.username}
            />
        </div>
        <div class="row">
            <label for="password" class="form-label"
                >{$_("editpw.password")}</label
            >
            <input
                type="text"
                class="form-control"
                id="password"
                placeholder={$_("editpw.password")}
        ...
        <div class="row">
            ...
            <input
                ...
                class="form-control"
                id="notes"
                placeholder={$_("editpw.notes")}
                value={password.notes}
            />
        </div>
        <button type="submit" class="btn btn-primary"
            >{$_("editpw.base")}</button
        >
        <button
            type="button"
            class="btn"
            on:click={() => invoke("close_edit_password")}
